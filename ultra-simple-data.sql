...
-- 현재 사용자 ID를 이용한 샘플 게시글 생성 (tags 제거)
DO $$
DECLARE
...
BEGIN
    ...
    (gen_random_uuid(), current_user_id, '재현파파', '밤중 수유, 이렇게 하면 편해요', 
     ...
     'infant', false, 4, 67, NOW() - INTERVAL '3 hours'),
    ...
    (gen_random_uuid(), current_user_id, '은희맘', '유치원 준비물, 이런 것들이 필요해요', 
     ...
     'preschool', false, 48, 156, NOW() - INTERVAL '5 days'),
    ...
    (gen_random_uuid(), current_user_id, '한할머니', '50년 육아 경험에서 나온 지혜', 
     ...
     'community', false, null, 203, NOW() - INTERVAL '1 week'),
    ...
    (gen_random_uuid(), current_user_id, '재현파파', '아내의 산후우울, 어떻게 도와야 할까요?', 
     ...
     'infant', true, 4, 156, NOW() - INTERVAL '1 day'),
...
-- 성공 메시지
SELECT '✅ 초간단 샘플 데이터 생성 완료! 15개의 게시글이 추가되었습니다.' as result;