-- =============================================
-- 초안전 샘플 데이터 - 모든 제약 조건 준수
-- baby_month: 0-36개월 범위로 제한
-- =============================================
...
BEGIN
    ...
    (gen_random_uuid(), current_user_id, '은희맘', '유치원 준비물, 이런 것들이 필요해요', 
     '36개월 셋째가 드디어 유치원에 입학해요! 첫째, 둘째 경험으로 정말 필요한 준비물들을 정리해봤어요. 1) 이름표, 2) 여벌옷 세트, 3) 실내화, 4) 물통과 컵, 5) 손수건과 티슈. 특히 아이가 스스로 신고 벗을 수 있는 신발을 선택하는게 중요해요!', 
     'toddler', false, 36, 156, NOW() - INTERVAL '5 days'),
...
-- 성공 메시지
SELECT '✅ 초안전 샘플 데이터 생성 완료! 15개의 게시글이 추가되었습니다.' as result;