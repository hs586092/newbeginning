...
CREATE TABLE IF NOT EXISTS hospitals (
  ...
  naver_id TEXT UNIQUE, -- 네이버 지도 Place ID
  name TEXT NOT NULL,
  address TEXT NOT NULL,
  road_address TEXT,
  phone TEXT,
  category TEXT NOT NULL, -- 소아과, 소아청소년과
  lat DOUBLE PRECISION NOT NULL,
  lng DOUBLE PRECISION NOT NULL,
  rating DECIMAL(2,1) DEFAULT 0,
  review_count INTEGER DEFAULT 0,
  opening_hours JSONB, -- {mon: "09:00-18:00", tue: "09:00-18:00", ...}
  features TEXT[], -- ['야간진료', '주말진료', '주차가능', etc]
  description TEXT,
  website TEXT,
  images TEXT[], -- 병원 사진 URLs
...
CREATE TABLE IF NOT EXISTS hospital_reviews (
  ...
  naver_review_id TEXT, -- 네이버 리뷰 ID (중복 방지)
  author_name TEXT,
  rating INTEGER CHECK (rating >= 1 AND rating <= 5),
  content TEXT NOT NULL,
  visit_date DATE,
  images TEXT[], -- 리뷰 사진 URLs
...
CREATE TABLE IF NOT EXISTS hospital_review_summaries (
  ...
  keywords JSONB, -- {friendly: 45, clean: 32, waiting: 28, ...}
...
-- 거리 계산 함수 (PostGIS 대신 간단한 Haversine)
