-- =============================================
-- NewBeginning RPC 함수 - 새 Supabase 프로젝트용
-- =============================================
...
-- 10. 실시간 알림을 위한 함수 (PostgreSQL LISTEN/NOTIFY)
...
DROP TRIGGER IF EXISTS post_change_notify ON posts;
...
-- 성공 메시지
SELECT '🎉 NewBeginning RPC 함수 설정 완료! 11개 함수 + 실시간 알림 시스템 생성됨' as result;