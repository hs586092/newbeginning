  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="bg-white rounded-lg shadow-sm border p-8">
        ...
        <nav className="mb-8 bg-gray-50 rounded-lg p-4">
          <h2 className="text-lg font-semibold mb-3 text-gray-900">목차</h2>
          <ol className="space-y-1 text-sm text-gray-700">
            <li><a href="#section1" className="hover:text-pink-600">1. 개인정보의 처리목적</a></li>
            <li><a href="#section2" className="hover:text-pink-600">2. 개인정보의 처리 및 보유기간</a></li>
            <li><a href="#section3" className="hover:text-pink-600">3. 처리하는 개인정보 항목</a></li>
            <li><a href="#section4" className="hover:text-pink-600">4. 개인정보의 제3자 제공</a></li>
            <li><a href="#section5" className="hover:text-pink-600">5. 개인정보의 파기</a></li>
            <li><a href="#section6" className="hover:text-pink-600">6. 정보주체의 권리·의무 및 행사방법</a></li>
            <li><a href="#section7" className="hover:text-pink-600">7. 개인정보의 안전성 확보조치</a></li>
            <li><a href="#section8" className="hover:text-pink-600">8. 개인정보보호책임자</a></li>
            <li><a href="#section9" className="hover:text-pink-600">9. 권익침해 구제방법</a></li>
            <li><a href="#section10" className="hover:text-pink-600">10. 개인정보처리방침 변경</a></li>
          </ol>
        </nav>

        <main className="space-y-8">
          <section id="section1" className="scroll-margin-top">
            <h2 className="text-xl font-bold text-gray-900 mb-4 border-l-4 border-pink-500 pl-4">
              제1조 (개인정보의 처리목적)
            </h2>
            <div className="text-gray-700 space-y-3 leading-relaxed">
              ...
              <div className="bg-pink-50 p-4 rounded-lg">
                <h3 className="font-semibold mb-2 text-pink-800">1. 회원가입 및 관리</h3>
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                <h3 className="font-semibold mb-2 text-blue-800">2. 서비스 제공</h3>
                <ul className="list-disc list-inside space-y-1 text-sm">
              ...
              <div className="bg-green-50 p-4 rounded-lg">
                <h3 className="font-semibold mb-2 text-green-800">3. 마케팅 및 광고 활용</h3>
                <ul className="list-disc list-inside space-y-1 text-sm">
              ...
              <div className="overflow-x-auto">
                <table className="w-full border-collapse border border-gray-300">
                  <thead className="bg-gray-50">
                    <tr>
                      <th className="border border-gray-300 px-4 py-2 text-left font-semibold">처리목적</th>
                  ...
                  <tbody>
                    ...
                    <tr className="bg-gray-50">
                      <td className="border border-gray-300 px-4 py-2">커뮤니티 서비스 제공</td>
                      <td className="border border-gray-300 px-4 py-2">회원탈퇴 시까지</td>
                      <td className="border border-gray-300 px-4 py-2">이용자 동의</td>
                    </tr>
                    <tr>
                      <td className="border border-gray-300 px-4 py-2">부정이용 방지</td>
                      <td className="border border-gray-300 px-4 py-2">3개월</td>
                      <td className="border border-gray-300 px-4 py-2">정보통신망법</td>
                    </tr>
                    <tr className="bg-gray-50">
                      <td className="border border-gray-300 px-4 py-2">서비스 이용기록</td>
                      <td className="border border-gray-300 px-4 py-2">3개월</td>
          ...
          <section id="section3" className="scroll-margin-top">
            ...
            <div className="text-gray-700 space-y-4 leading-relaxed">
              <div className="bg-yellow-50 p-4 rounded-lg">
                <h3 className="font-semibold mb-3 text-yellow-800">필수 개인정보</h3>
                <ul className="list-disc list-inside space-y-1 text-sm">
              ...
              <div className="bg-purple-50 p-4 rounded-lg">
                <h3 className="font-semibold mb-3 text-purple-800">선택 개인정보</h3>
                <ul className="list-disc list-inside space-y-1 text-sm">
            ...
            <div className="text-gray-700 space-y-4 leading-relaxed">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-indigo-50 p-4 rounded-lg">
                  <h3 className="font-semibold mb-2 text-indigo-800">파기절차</h3>
                  <ul className="list-disc list-inside space-y-1 text-sm">
                    <li>파기 사유 발생</li>
                    <li>파기 계획 수립</li>
                    <li>개인정보보호책임자 승인</li>
                ...
                <div className="bg-teal-50 p-4 rounded-lg">
                  <h3 className="font-semibold mb-2 text-teal-800">파기방법</h3>
                  <ul className="list-disc list-inside space-y-1 text-sm">
            ...
            <div className="text-gray-700 space-y-4 leading-relaxed">
              ...
              <div className="grid gap-4">
                <div className="bg-emerald-50 p-4 rounded-lg">
                  <h3 className="font-semibold mb-2 text-emerald-800">귀하의 권리</h3>
                  <ul className="list-disc list-inside space-y-1 text-sm">
                ...
                <div className="bg-orange-50 p-4 rounded-lg">
                  <h3 className="font-semibold mb-2 text-orange-800">권리 행사 방법</h3>
            ...
            <div className="text-gray-700 space-y-4 leading-relaxed">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="bg-red-50 p-4 rounded-lg">
                  <h3 className="font-semibold mb-2 text-red-800">기술적 조치</h3>
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  <h3 className="font-semibold mb-2 text-blue-800">관리적 조치</h3>
                  <ul className="list-disc list-inside space-y-1 text-xs">
                    <li>개인정보 취급직원 지정</li>
                    <li>개인정보보호 교육</li>
                    <li>내부관리계획 수립</li>
                ...
                <div className="bg-green-50 p-4 rounded-lg">
                  <h3 className="font-semibold mb-2 text-green-800">물리적 조치</h3>
                  <ul className="list-disc list-inside space-y-1 text-xs">
                    <li>전산실 접근통제</li>
                    <li>개인정보 보관 잠금장치</li>
                    <li>비인가자 출입 통제</li>
          ...
          <section id="section8" className="scroll-margin-top">
            ...
            <div className="text-gray-700 space-y-4 leading-relaxed">
              ...
              <div className="bg-gradient-to-r from-pink-50 to-blue-50 p-6 rounded-lg border-2 border-pink-200">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h3 className="font-semibold mb-3 text-pink-800">개인정보보호책임자</h3>
                  ...
                  <div>
                    <h3 className="font-semibold mb-3 text-blue-800">개인정보보호담당자</h3>
                    <ul className="space-y-2 text-sm">
            ...
            <div className="text-gray-700 space-y-4 leading-relaxed">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h3 className="font-semibold mb-2 text-gray-800">개인정보침해신고센터</h3>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h3 className="font-semibold mb-2 text-gray-800">개인정보분쟁조정위원회</h3>
                  <ul className="space-y-1 text-sm">
              ...
              <div className="bg-amber-50 p-4 rounded-lg border-l-4 border-amber-400">
                <h3 className="font-semibold mb-2 text-amber-800">기타 신고기관</h3>
          ...
          <section id="section10" className="scroll-margin-top">
            ...
            <div className="text-gray-700 space-y-3 leading-relaxed">
              ...
              <div className="bg-pink-50 p-4 rounded-lg border border-pink-200">
                <h3 className="font-semibold mb-2 text-pink-800">개정 이력</h3>
                <ul className="space-y-1 text-sm">
        ...
        <footer className="mt-12 pt-8 border-t border-gray-200">
          <div className="text-center text-sm text-gray-500">
            ...
            <p className="mt-2">개인정보 관련 문의: 
              <a href="mailto:privacy@firstbirthday.kr" className="text-pink-600 hover:underline">
